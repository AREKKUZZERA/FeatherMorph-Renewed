...
val targetDevBundle = paperDevBundleVersions[mcTarget] ?: "$mcTarget-R0.1-SNAPSHOT"

val resolvedMinecraftVersion = if (project.hasProperty("mc_target"))
    targetDevBundle
else
    providers.gradleProperty("minecraft_version").getOrElse(targetDevBundle)
...
dependencies {
    paperweight.paperDevBundle(resolvedMinecraftVersion)
...
tasks.shadowJar {
    ...
    archiveFileName = "feathermorph-${project.property("project_version")}-$mcTarget-final.jar"
}
